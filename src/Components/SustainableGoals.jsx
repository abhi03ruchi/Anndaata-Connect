  ...
  return (
    <div className="bg-[#fff5f3] py-24 sm:py-32 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 lg:px-8" ref={ref}>
        ...
        <div className="mx-auto mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center justify-center">
          {images.map((img, index) => (
            <div
              key={img.id}
              className={`flex justify-center items-center transform transition-all duration-700 hover:z-10 ${
                inView
            ...
            >
              <div className="relative group">
                ...
                >
                  ...
                  <img
                    className="w-54 sm:w-76 md:w-98 lg:130 h-auto rounded-xl shadow-lg hover:shadow-2xl transform transition-transform duration-500"
                    src={img.src}
                    alt={img.alt}
                  />
                  <div
