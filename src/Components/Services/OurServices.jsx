...
const OurServices = () => {
    return (
        <>
            ...
            <div
                id="ourServices"
                className="h-auto bg-[whitesmoke] lg:h-auto relative lg:p-20 lg:ml-20 lg:mr-20 pb-20"
            >
                <div className="relative z-[5]">
                    ...
                    <div
                        id="cardContainer"
                        className="mt-5 lg:flex lg:flex-row lg:p-10 lg:mt-6 lg:justify-evenly space-y-8 lg:space-y-0"
                    >
                        <div
                            id="tailorCard"
                            className="lg:mt-0"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span
                                        className="text-lg lg:text-4xl text-[#28183b]"
                                        style={{
                                ...
                                <p className="text-xs lg:text-base px-20 lg:px-10 py-5 lg:p-3">
                                    The service provides a seamless connection between individuals
                                    and restaurants with surplus food to spare, and NGOs dedicated
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span className="text-lg lg:text-3xl text-[#28183b]">
                                        DONATE FOOD
                                    </span>
                                </div>
                                <p className="text-xs lg:text-base px-20 lg:px-10 py-5 lg:p-3">
                                    The service empowers individuals hosting events, such as
                                    weddings or functions, to effortlessly contribute their excess
