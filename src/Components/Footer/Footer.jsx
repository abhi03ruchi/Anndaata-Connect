    ...
    return (
        <footer className="bg-[#302f2f] ">
            <div className="mx-auto w-full max-w-screen-xl  lg:py-8">
                ...
                <hr className="my-6 border-[#e26959] sm:mx-auto  lg:my-8" />
                <div className=" text-lg sm:flex sm:items-center sm:justify-between ">
                    <span className=" text-gray-50 sm:text-center">
                        © 2023{" "}
                        <a href="https://flowbite.com/" className="hover:underline">
                            AnnDaata Connect
                        </a>
