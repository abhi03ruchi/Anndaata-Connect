...
import solidarity from "../assets/logo.png";
    ...
    return (
        <>
            ...
            <footer className=" main-font">
                ...
                >
                    <div className="row">
                        <div className="custom-column-lg-5 custom-column-md-5 custom-margin-bottom-lg-0 custom-padding-x-5">
                            <div className="custom-column-sm-3 custom-column-6 custom-column-lg-3 custom-margin-x-auto custom-margin-lg-x-0">
                                <img
                                    src={solidarity}
                                    alt="milan logo"
                            ...
                            {isMobile ? (
                                <p className="socail-heading">
                                    Check out our socials
                                </p>
                            ) : (
                                <p className="custom-footer-text headings">
                        ...
                        <div className="custom-join-us">
                            <div className="join">
                                <p className="custom-heading mb-lg-2 mb-3 headings">
                                    {Cookies.get("isLoggedIn") ? "Explore!" : "Join Us"}
                                </p>
                                <ul className="join-us-list custom-list">
                                    <li className="mb-2">
                                        {Cookies.get("isLoggedIn") ? (
                                            ...
                                            <Link
                                                to="/auth/login"
                                                className="register-name footer_auth_text"
                                            >
                                                Login
                                            </Link>
                                        )}
                    ...
                    <div className="socials custom-socials">
                    ...
                    <p className="developed" role="contentinfo">
                        Developed by team{" "}
                        <span
                            onClick={clickMilan}
                            style={{
