  ...
  return (
    <>
      ...
      <div className="privacy-container">
        ...
        <section>
          <h2>Your Rights</h2>
          <p>You have the right to access, correct, or delete your personal information. Contact us at <a href='mailto:privacy@anndaata.org' target='_blank' rel='noreferrer'><strong>privacy@anndaata.org</strong></a> for any requests.</p>
        </section>
        ...
        <p>If you have any questions about this Privacy Policy, contact us at <a href='mailto:support@anndaata.org' target='_blank' rel='noreferrer'><strong>support@anndaata.org</strong></a>.</p>
      </div>
      <Footer />
    </>
  );
